...
const NAME_REGEX = /^wtk-[a-z0-9]+(-[a-z0-9]+)*$/;
...
function validateSkill(skillDir) {
  ...
  // TODO: wtk-agent-tech-writer has sub-skill files with intentional name/description
  const WF_SKIP_SKILLS = new Set(['wtk-agent-tech-writer']);
