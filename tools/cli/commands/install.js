...
module.exports = {
  command: 'install',
  description: 'Install WTK Core agents and tools',
  options: [
    ...
    ['--output-folder <path>', 'Output folder path relative to project root (default: _wtk-output)'],
  ...
  action: async (options) => {
    try {
      ...
      if (options.debug) {
        process.env.WTK_DEBUG_MANIFEST = 'true';
