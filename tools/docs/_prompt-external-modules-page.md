...
Create a reference documentation page at `docs/reference/modules.md` that lists all official external Wtk modules with descriptions and links.
...
- Start with a brief intro explaining that Wtk extends through official modules selected during installation
