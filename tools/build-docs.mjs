/**
 * WTK Documentation Build Pipeline
 *
...
const REPO_URL = 'https://github.com/wtk-code-org/WTK-METHOD';
...
// Main Entry Point
/**
 * Orchestrates the full WTK documentation build pipeline.
 *
...
async function main() {
  ...
  console.log();
  printBanner('WTK Documentation Build Pipeline');
  console.log();
...
function generateLlmsTxt(outputDir) {
  ...
  const content = [
    ...
    '## Quick Start',
    '',
    `- **[Getting Started](${siteUrl}/tutorials/getting-started/)** - Tutorial: install and learn how Wtk works`,
    `- **[Installation](${siteUrl}/how-to/install-wtk/)** - How to install Wtk Method`,
    '',
    '## Core Concepts',
    '',
