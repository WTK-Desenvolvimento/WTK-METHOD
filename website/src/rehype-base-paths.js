 ...
 *
 * Transforms:
 *   /img/foo.png → /WTK-METHOD/img/foo.png (when base is /WTK-METHOD/)
 *   /llms.txt → /WTK-METHOD/llms.txt
 *
 * Supported elements:
 ...
 * @param {string} options.base - The base path to prepend (e.g., '/WTK-METHOD/')
...
export default function rehypeBasePaths(options = {}) {
  ...
  // produces correct paths like /WTK-METHOD/img/foo.png.
