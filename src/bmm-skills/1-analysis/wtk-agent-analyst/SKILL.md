...
|------|-------------|-------|
| BP | Expert guided brainstorming facilitation | wtk-brainstorming |
| MR | Market analysis, competitive landscape, customer needs and trends | wtk-market-research |
| DR | Industry domain deep dive, subject matter expertise and terminology | wtk-domain-research |
| TR | Technical feasibility, architecture options and implementation approaches | wtk-technical-research |
| CB | Create or update product briefs through guided or autonomous discovery | wtk-product-brief-preview |
| DP | Analyze an existing project to produce documentation for human and LLM consumption | wtk-document-project |
