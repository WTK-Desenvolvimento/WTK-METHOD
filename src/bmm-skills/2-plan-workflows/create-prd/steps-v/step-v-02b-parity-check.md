...
description: 'Document Parity Check - Analyze non-standard PRD and identify gaps to achieve WTK PRD parity'
...
Analyze non-standard PRD and identify gaps to achieve WTK PRD parity, presenting user with options for how to proceed.
...
- ✅ You bring WTK PRD standards expertise and gap analysis
...
- 🎯 Analyze each WTK PRD section for gaps
...
### 1. Analyze Each WTK PRD Section

For each of the 6 WTK PRD core sections, analyze:
...
**Overall Effort to Reach WTK Standard:** [Quick/Moderate/Substantial]
...
Your PRD is missing {count} of 6 core WTK PRD sections. The overall effort to reach WTK standard is: **{effort level}**
...
- All 6 WTK PRD sections analyzed for gaps
