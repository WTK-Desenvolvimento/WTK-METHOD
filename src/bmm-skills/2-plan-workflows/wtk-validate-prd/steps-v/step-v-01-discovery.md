...
This file contains the WTK PRD philosophy, standards, and validation criteria that will guide all validation checks. Internalize this understanding - it defines what makes a great WTK PRD.
...
- IF A: Invoke the `wtk-advanced-elicitation` skill, and when finished redisplay the menu
- IF P: Invoke the `wtk-party-mode` skill, and when finished redisplay the menu
