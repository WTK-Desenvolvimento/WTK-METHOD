...
Detect if PRD follows WTK format and route appropriately - classify as WTK Standard / WTK Variant / Non-Standard, with optional parity check for non-standard formats.
...
### 2. Check for WTK PRD Core Sections

Check if the PRD contains the following WTK PRD core sections:
...
- Follows WTK PRD structure closely

**WTK Variant:**
- 3-4 core sections present
- Generally follows WTK patterns but may have structural differences
- Missing some sections but recognizable as WTK-style

**Non-Standard:**
- Fewer than 3 core sections present
- Does not follow WTK PRD structure
...
**Format Classification:** [WTK Standard / WTK Variant / Non-Standard]
**Core Sections Present:** [count]/6
```

### 5. Route Based on Format Classification

**IF format is WTK Standard or WTK Variant:**
...
This PRD does not follow WTK standard structure (only {count}/6 core sections present).
...
**[A] Parity Check** - Analyze gaps and estimate effort to reach WTK PRD parity
...
- WTK core sections checked systematically
- Format classified correctly based on section count
- Findings reported to validation report
- WTK Standard/Variant PRDs proceed directly to next validation step
