...
Assess the PRD as a cohesive, compelling document - evaluating document flow, dual audience effectiveness (humans and LLMs), WTK PRD principles compliance, and overall quality rating.
...
- 🎯 Evaluate document flow, dual audience, WTK principles
...
Invoke the `wtk-advanced-elicitation` skill
...
**3. WTK PRD Principles Compliance:**
...
- Check WTK principles compliance
...
- WTK PRD principles compliance checked
...
- Not checking all WTK principles
