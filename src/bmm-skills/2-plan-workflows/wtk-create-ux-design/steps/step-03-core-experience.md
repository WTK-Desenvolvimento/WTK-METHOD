...
- Invoke the `wtk-advanced-elicitation` skill with the current core experience content
...
- Invoke the `wtk-party-mode` skill with the current core experience definition
