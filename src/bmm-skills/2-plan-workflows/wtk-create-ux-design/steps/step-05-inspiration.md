...
- Invoke the `wtk-advanced-elicitation` skill with the current inspiration analysis content
...
- Invoke the `wtk-party-mode` skill with the current inspiration analysis
