...
- Invoke the `wtk-advanced-elicitation` skill with the current defining experience content
...
- Invoke the `wtk-party-mode` skill with the current defining experience
