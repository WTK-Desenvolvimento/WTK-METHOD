...
- Invoke the `wtk-advanced-elicitation` skill with the current emotional response content
...
- Invoke the `wtk-party-mode` skill with the current emotional response definition
