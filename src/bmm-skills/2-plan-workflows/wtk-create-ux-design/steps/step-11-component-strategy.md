...
- Invoke the `wtk-advanced-elicitation` skill with the current component strategy content
...
- Invoke the `wtk-party-mode` skill with the current component strategy
