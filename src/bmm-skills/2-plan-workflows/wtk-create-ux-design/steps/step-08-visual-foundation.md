...
- Invoke the `wtk-advanced-elicitation` skill with the current visual foundation content
...
- Invoke the `wtk-party-mode` skill with the current visual foundation
