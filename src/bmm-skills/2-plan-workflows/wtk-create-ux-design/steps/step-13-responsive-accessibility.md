...
- When 'A' selected: Invoke the `wtk-advanced-elicitation` skill
- When 'P' selected: Invoke the `wtk-party-mode` skill
...
- Invoke the `wtk-advanced-elicitation` skill with the current responsive/accessibility content
...
- Invoke the `wtk-party-mode` skill with the current responsive/accessibility strategy
