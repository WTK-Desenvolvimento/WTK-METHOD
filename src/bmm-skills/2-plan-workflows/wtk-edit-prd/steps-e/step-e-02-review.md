...
2. Analyze against WTK standards (from prd-purpose.md)
...
- IF A: Invoke the `wtk-advanced-elicitation` skill, then return to discussion
- IF P: Invoke the `wtk-party-mode` skill, then return to discussion
