...
prdPurpose: '{project-root}/_wtk/bmm-skills/2-plan-workflows/create-prd/data/prd-purpose.md'
---
...
This file defines what makes a great WTK PRD. Internalize this understanding - it will guide improvement recommendations.
...
- Convert to WTK format (if legacy PRD)
...
**Check for WTK PRD core sections:**
1. Executive Summary
2. Success Criteria
3. Product Scope
4. User Journeys
...
**Classify format:**
- **WTK Standard:** 5-6 core sections present
- **WTK Variant:** 3-4 core sections present, generally follows WTK patterns
- **Legacy (Non-Standard):** Fewer than 3 core sections, does not follow WTK structure

### 8. Route Based on Format and Context

**IF validation report provided OR PRD is WTK Standard/Variant:**
...
**[C] Convert to WTK Format** - Convert PRD to WTK standard structure, then apply your edits
...
- WTK PRDs proceed directly to review step
