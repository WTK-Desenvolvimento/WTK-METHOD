...
Analyze legacy PRD against WTK standards, identify gaps, propose conversion strategy, and let user choose how to proceed.
...
- ✅ You bring WTK standards expertise and conversion guidance
...
- 🎯 Analyze legacy PRD against WTK standard
...
**For each WTK PRD section, analyze:**
...
- Manually check PRD for each WTK section
...
**[R] Restructure to WTK** - Full conversion to WTK format, then apply your edits
...
- All 6 WTK core sections analyzed for gaps
