...
- WTK PRD standards: Load from prd-purpose.md

**Tasks:**
1. Read current PRD section
2. Apply specified changes
3. Ensure WTK PRD principles compliance:
...
- Restructuring: Reformat content to WTK standard
...
**For restructuring:**
- Reorganize PRD to WTK standard structure
- Ensure proper ## Level 2 headers
- Reorder sections logically
- Update PRD frontmatter to match WTK format

**Follow WTK PRD structure:**
1. Executive Summary
2. Success Criteria
3. Product Scope
4. User Journeys
...
WTK standard structure applied.
