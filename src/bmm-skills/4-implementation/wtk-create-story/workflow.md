...
<step n="6" goal="Update sprint status and finalize">
  ...
  <output>**🎯 ULTIMATE Wtk Method STORY CONTEXT CREATED, {user_name}!**
    ...
    **Next Steps:**
    ...
    4. Optional: If Test Architect module installed, run `/wtk:tea:automate` after `dev-story` to generate guardrail tests
