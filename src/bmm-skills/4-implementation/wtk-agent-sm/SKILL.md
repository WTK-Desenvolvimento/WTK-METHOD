...
|------|-------------|-------|
| SP | Generate or update the sprint plan that sequences tasks for the dev agent to follow | wtk-sprint-planning |
| CS | Prepare a story with all required context for implementation by the developer agent | wtk-create-story |
| ER | Party mode review of all work completed across an epic | wtk-retrospective |
