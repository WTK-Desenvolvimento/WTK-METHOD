...
We recommend always using the latest version of Wtk Method to ensure you have the most recent security updates.
...
1. **GitHub Security Advisories** (Preferred): Use [GitHub's private vulnerability reporting](https://github.com/wtk-code-org/WTK-METHOD/security/advisories/new) to submit a confidential report.
...
- Vulnerabilities in Wtk Method core framework code
...
We appreciate the security research community's efforts in helping keep Wtk Method secure. Contributors who report valid security issues will be acknowledged in our security advisories.

---

Thank you for helping keep Wtk Method and our community safe.
