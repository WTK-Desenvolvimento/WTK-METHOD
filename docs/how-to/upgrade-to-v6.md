...
description: Migrate from Wtk v4 to v6
sidebar:
  order: 3
---

Use the Wtk installer to upgrade from v4 to v6, which includes automatic detection of legacy installations and migration assistance.

## When to Use This

- You have Wtk v4 installed (`.wtk-method` folder)
- You want to migrate to the new v6 architecture
- You have existing planning artifacts to preserve

:::note[Prerequisites]
- Node.js 20+
- Existing Wtk v4 installation
:::
...
Follow the [Installer Instructions](./install-wtk.md).

### 2. Handle Legacy Installation

When v4 is detected, you can:

- Allow the installer to back up and remove `.wtk-method`
...
Move them to `_wtk-output/planning-artifacts/` with descriptive names:
...
2. Place `epics.md` or `epics/epic*.md` in `_wtk-output/planning-artifacts/`
3. Run the Scrum Master's `wtk-sprint-planning` workflow
...
```text
your-project/
├── _wtk/               # Single installation folder
│   ├── _config/         # Your customizations
│   │   └── agents/      # Agent customization files
│   ├── core/            # Universal core framework
│   ├── bmm/             # Wtk Method module
│   ├── bmb/             # Wtk Builder
│   └── cis/             # Creative Intelligence Suite
└── _wtk-output/        # Output folder (was doc folder in v4)
```
...
| v4 Module                     | v6 Status                                 |
| ----------------------------- | ----------------------------------------- |
| `.wtk-2d-phaser-game-dev`    | Integrated into BMGD Module               |
| `.wtk-2d-unity-game-dev`     | Integrated into BMGD Module               |
| `.wtk-godot-game-dev`        | Integrated into BMGD Module               |
| `.wtk-infrastructure-devops` | Deprecated — new DevOps agent coming soon |
| `.wtk-creative-writing`      | Not adapted — new v6 module coming soon   |

## Key Changes

| Concept       | v4                                    | v6                                   |
| ------------- | ------------------------------------- | ------------------------------------ |
| **Core**      | `_wtk-core` was actually Wtk Method | `_wtk/core/` is universal framework |
| **Method**    | `_wtk-method`                        | `_wtk/bmm/`                         |
