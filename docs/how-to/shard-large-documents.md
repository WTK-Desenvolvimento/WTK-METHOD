...
Use the `wtk-shard-doc` tool if you need to split large markdown files into smaller, organized files for better context management.
...
Wtk workflows use a **dual discovery system**:
