...
description: Common questions about using Wtk Method on established projects
sidebar:
  order: 8
---
Quick answers to common questions about working on established projects with the Wtk Method (BMM).
...
**Have a question not answered here?** Please [open an issue](https://github.com/wtk-code-org/WTK-METHOD/issues) or ask in [Discord](https://discord.gg/gk8jAdXWmj) so we can add it!
