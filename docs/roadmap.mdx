...
<div class="roadmap-container">
  ...
  <div style="text-align: center; margin-top: 3rem; padding: 2rem; background: var(--color-bg-card); border-radius: 12px; border: 1px solid var(--color-border);">
    ...
    <p style="color: var(--slate-color-400); margin: 0;">
      ...
      <a href="https://github.com/wtk-automacao/wtk-method" style="color: var(--color-in-progress);">Join us on GitHub</a> to help shape the future of AI-driven development.
    </p>
    <p style="color: var(--slate-color-400); margin: 1.5rem 0 0;">
      Love what we're building? We appreciate both one-time and monthly{" "}<a href="https://buymeacoffee.com/wtk" style="color: var(--color-in-progress);">support</a>.
    </p>
