...
* Fix manifest generation so Wtk Builder installs correctly when a module has no agents (#1998)
* Prototype preview of wtk-product-brief-preview skill — try `/wtk-product-brief-preview` and share feedback! (#1959)
...
* Improve wtk-help description for accurate trigger matching (#2012)
* Point zh-cn doc links to Chinese pages instead of English (#2010)
* Validation cleanup for wtk-quick-flow (#1997), 6 skills batch (#1996), wtk-sprint-planning (#1995), wtk-retrospective (#1993), wtk-dev-story (#1992), wtk-create-story (#1991), wtk-code-review (#1990), wtk-create-epics-and-stories (#1989), wtk-create-architecture (#1987), wtk-check-implementation-readiness (#1986), wtk-create-ux-design (#1983), wtk-create-product-brief (#1982)
...
* Support @next installation channel (`npx wtk-method@next install`) — get the latest tip of main instead of waiting for the next stable published version
...
* Convert entire WTK method to skills-based architecture with unified skill manifests (#1834)
...
* Add wtk-os-root-cause-analysis skill for analyzing bug-fix commits and producing structured root cause analysis reports with pyramid communication format (#1741)

### 🐛 Bug Fixes

* Fix installer to refuse installation when ancestor directory has WTK commands, preventing duplicate command autocompletion in nested directories (#1735)
...
* Rebrand WTK acronym to "Build More Architect Dreams" across documentation (#1765)
...
* Convert review-pr and audit-file-refs tools to proper wtk-os skills with slash commands `wtk-os-review-pr` and `wtk-os-audit-file-refs` (#1732)
...
* Fix 104 relative step file references to use standardized `{project-root}/_wtk/` paths across 68 files (#1722)
...
* Elevate `wtk-help` as primary on-ramp across all documentation
* Update workflow names with `wtk-bmm-` prefix and standardize table formatting
...
* Add Wtk Builder link to index for extenders
...
* **wtk-help** — Now reads project-specific docs and respects `communication_language` setting (#1535)
...
* **Internal Skill Renaming** — Renamed internal project skills to use `wtk-os-` prefix for consistent naming (5276d58b)
...
* **Centralized Constants** — Centralized `WTK_FOLDER_NAME` to reduce hardcoded strings (PR #1492)
...
* **Fix leaked source paths in PRD validation report** — Replace absolute `/src/core/` paths with `{project-root}/_wtk/core/` (#1481)
...
- **Quick-flow workflow path fix** (#1368): Fixed incorrect workflow_path in wtk-quick-flow/quick-spec steps (step-01, step-02, step-03) - changed from non-existent 'create-tech-spec' to correct 'quick-spec'
...
- **Transition from Alpha to Beta**: Wtk Method is now in Beta! This marks a significant milestone in the framework's development
- **NPM Default Tag**: Beta versions are now published with the `latest` tag, making `npx wtk-method` serve the beta version by default

### 🌟 Key Highlights

1. **wtk-help**: Revolutionary AI-powered guidance system replaces the alpha workflow-init and workflow tracking — introduces full AI intelligence to guide users through workflows, commands, and project context
2. **Module Ecosystem Expansion**: wtk-builder, CIS (Creative Intelligence Suite), and Game Dev Studio moved to separate repositories for focused development
3. **Installer Consolidation**: Unified installer architecture with standardized command naming (`wtk-dash-case.md` or `wtk-*-agent-*.md`)
4. **Windows Compatibility**: Complete migration from Inquirer.js to @clack/prompts for reliable cross-platform support

### 🚀 Major Features

**wtk-help - Intelligent Guidance System:**
...
| ------------------------------------- | ------------------------------------------------- | ------------------------------------------------------- |
| **wtk-builder**                      | Near beta, with docs and walkthroughs coming soon | `wtk-code-org/wtk-builder`                            |
| **CIS** (Creative Intelligence Suite) | Published as npm package                          | `wtk-code-org/wtk-module-creative-intelligence-suite` |
| **Game Dev Studio**                   | Published as npm package                          | `wtk-code-org/wtk-module-game-dev-studio`             |
...
- Standardized command naming conventions:
  - Workflows: `wtk-module-workflow-name.md`
  - Agents: `wtk-module-agent-name.md`
  - Tasks: `wtk-task-name.md`
  - Tools: `wtk-tool-name.md`
...
- README overhaul with numbered command flows and prominent `wtk-help` callout
...
- **Downloadable Source Bundles**: wtk-sources.zip and wtk-prompts.zip for offline use
...
- **Wtk Acronym Standardization**: Consistent use of "Wtk" (Breakthrough Method of Agile AI Driven Development)
...
- **Cleanup Integration**: Automatic cleanup of old WTK commands alongside rules
...
- **Documentation Links**: Fixed Discord channel references (#general-dev → #wtk-development)
...
5. **WTK Core Concepts**: New documentation structure explaining agents, workflows, modules, and installation
...
### 📚 WTK Core Concepts Documentation

**New Documentation Structure:**

`docs/wtk-core-concepts/`:

- **index.md** - Core concepts introduction
- **agents.md** (93 lines) - Understanding agents in WTK
- **workflows.md** (89 lines) - Understanding workflows in WTK
...
- **wtk-customization/index.md** - Customization overview
- **wtk-customization/agents.md** - Agent customization guide
- **wtk-customization/workflows.md** (30 lines) - Workflow customization guide
...
- **Removed getting-started/installation.md** - Migrated to wtk-core-concepts
...
- **BMB Module**: 3 agents with standardized menus (wtk-builder, agent-builder, module-builder, workflow-builder)
- **Core Module**: WTK Master agent updated with consistent menu patterns
...
- **Dot-Folder to Underscore Migration**: Critical change from `.bmad` to `_bmad` ensures LLMs (Codex, Claude, and others) can no longer ignore or skip WTK content - dot folders are commonly filtered out by AI systems
- **Universal Content Visibility**: Underscore folders are treated as regular content, ensuring full AI agent access to all WTK resources and configurations
- **Agent Memory Architecture**: Rolled out comprehensive agent memory support for installed agents with `-sidecar` folders
- **Persistent Agent Learning**: Sidecar content installs to `_wtk/_memory`, giving each agent the ability to learn and remember important information specific to its role

**Content Location Strategy:**

- **Standardized Memory Location**: All sidecar content now uses `_wtk/_memory` as the unified location for agent memories
...
3. **AI Visibility Breakthrough**: Migration from `.bmad` to `_bmad` ensures LLMs can access all WTK content (dot folders are commonly ignored by AI systems)
4. **Agent Memory System**: Rolled out persistent agent memory support - agents with `-sidecar` folders can now learn and remember important information in `_wtk/_memory`
...
- **Sidecar File Cleanup**: Removed old .wtk-user-memory folders from wellness modules
...
- **Built-in Validation System**: Ensures module quality and Wtk Core compliance
- **Professional Documentation**: Auto-generated module documentation and structure

### 🚀 Wtk Method (BMM) Enhancements
...
- **Wtk Core Compliance**: Full compliance with Wtk standards
...
- Added missing `yaml` dependency to fix `MODULE_NOT_FOUND` error when running `npx wtk-method install`
...
- **Lean Core**: Simple common tasks and agents (wtk-web-orchestrator, wtk-master)
- **Wtk Method (BMM)**: Complete scale-adaptive rewrite supporting projects from small enhancements to massive undertakings
- **BoMB**: Wtk Builder for creating and converting modules, workflows, and agents
...
## [v4.43.0](https://github.com/wtk-code-org/WTK-METHOD/releases/tag/v4.43.0)
...
- **File Exclusion**: `.wtk-flattenignore` support for flattener
...
- **Update Checker**: `npx wtk-method update-check` command
...
[View v4.43.1 tag](https://github.com/wtk-code-org/WTK-METHOD/tree/v4.43.1)

## [v4.30.0](https://github.com/wtk-code-org/WTK-METHOD/releases/tag/v4.30.0)
...
- **Wtk Subdirectory**: Organized command structure
- **Nested Organization**: Clean command hierarchy

### Agent Enhancements

- Wtk-master knowledge base loading
...
[View v4.30.4 tag](https://github.com/wtk-code-org/WTK-METHOD/tree/v4.30.4)

## [v4.20.0](https://github.com/wtk-code-org/WTK-METHOD/releases/tag/v4.20.0)
...
[View v4.20.0 tag](https://github.com/wtk-code-org/WTK-METHOD/tree/v4.20.0)

## [v4.10.0](https://github.com/wtk-code-org/WTK-METHOD/releases/tag/v4.10.0)

**Release: June 2025 (v4.3.0 - v4.10.3)**

This release focused on making WTK more configurable and adaptable to different project structures.
...
[View v4.10.3 tag](https://github.com/wtk-code-org/WTK-METHOD/tree/v4.10.3)

## [v4.0.0](https://github.com/wtk-code-org/WTK-METHOD/releases/tag/v4.0.0)

**Release: June 20, 2025 (v4.0.0 - v4.2.0)**

Version 4 represented a complete architectural overhaul, transforming WTK from a collection of prompts into a professional, distributable framework.

### Framework Transformation

- **NPM Package**: Professional distribution and simple installation via `npx wtk-method install`
- **Modular Architecture**: Move to `.wtk-core` hidden folder structure
...
[View v4.2.0 tag](https://github.com/wtk-code-org/WTK-METHOD/tree/v4.2.0)

## [v3.0.0](https://github.com/wtk-code-org/WTK-METHOD/releases/tag/v3.0.0)
...
- **Wtk Orchestrator**: Uber-agent that orchestrates all specialized agents
...
[View V3 Branch](https://github.com/wtk-code-org/WTK-METHOD/tree/V3)

## [v2.0.0](https://github.com/wtk-code-org/WTK-METHOD/releases/tag/v2.0.0)
...
[View V2 Branch](https://github.com/wtk-code-org/WTK-METHOD/tree/V2)

## [v1.0.0](https://github.com/wtk-code-org/WTK-METHOD/releases/tag/v1.0.0)

**Initial Release: April 6, 2025**

The original WTK Method was a tech demo showcasing how different custom agile personas could be used to build out artifacts for planning and executing complex applications from scratch. This initial version established the foundation of the AI-driven agile development approach.
...
[View V1 Branch](https://github.com/wtk-code-org/WTK-METHOD/tree/V1)
...
For detailed release notes, see the [GitHub releases page](https://github.com/wtk-code-org/WTK-METHOD/releases).
